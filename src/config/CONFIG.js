...
export default {
  "api": {
    "marvel_comics_listing": `https://gateway.marvel.com:443/v1/public/comics?apikey=${apikey}`,
    "marvel_characters_listing": `https://gateway.marvel.com:443/v1/public/characters?apikey=${apikey}`,
